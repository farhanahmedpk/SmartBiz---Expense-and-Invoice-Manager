...
import { ArrowRight, CheckCircle2, ShieldCheck, Briefcase, Mail, Lock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex flex-col lg:flex-row overflow-hidden font-sans selection:bg-blue-500/30">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-16 relative overflow-hidden bg-gradient-to-br from-blue-900 via-blue-950 to-slate-950">
          ...
          <div className="space-y-10 max-w-lg">
            ...
            >
              <h1 className="text-6xl font-bold text-white leading-[1.1] tracking-tight mb-6">
                Start your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-300">business journey.</span>
              </h1>
              <p className="text-blue-100/70 text-lg font-medium leading-relaxed">
                Join thousands of entrepreneurs who trust SmartBiz to handle the complexity of finance, clients, and growth.
              </p>
            </motion.div>
            ...
            <div className="space-y-5">
              {[
                ...
                "Secure Client Portals Included",
        ...
        <div className="z-10">
          <div className="bg-white/5 border border-white/10 rounded-3xl p-6 max-w-sm backdrop-blur-md">
            <p className="text-white/90 font-medium italic text-sm leading-relaxed mb-4">
              "SmartBiz transformed how we handle billing. We saved 15 hours a month in manual follow-ups."
            </p>
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-full bg-slate-800 border-2 border-blue-400/50 overflow-hidden">
                <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Felix" alt="Testimonial" />
              </div>
              <div>
                <p className="text-white text-xs font-bold uppercase tracking-widest">Felix Arvid</p>
                <p className="text-blue-300 text-[10px] font-bold uppercase tracking-wider">Agile Lead at Nexus</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center p-8 sm:p-12 lg:p-24 relative overflow-hidden bg-slate-950">
        ...
        <div className="lg:hidden mb-12 flex justify-between items-center relative z-10">
           ...
           <Link to="/login" className="text-sm font-bold text-blue-400 hover:text-blue-300">Sign In</Link>
        </div>
        ...
        >
          <div className="mb-10 text-center lg:text-left">
            <h1 className="text-4xl sm:text-5xl font-black text-white tracking-tight leading-none mb-4">Get started</h1>
            <p className="text-white/40 text-sm font-medium tracking-wide">Create your enterprise command center</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold text-white/50 uppercase tracking-widest px-1">Business Name</label>
                <div className="relative group">
                  <Briefcase className="absolute left-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-blue-400 transition-colors pointer-events-none" size={18} />
                  <input
                    type="text"
                    required
                    value={businessName}
              ...
              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold text-white/50 uppercase tracking-widest px-1">Security Password</label>
                <div className="relative group">
            ...
            >
              ...
              {isLoading ? (
                ...
                <>
                  <span className="relative z-10">Deploy Account</span>
